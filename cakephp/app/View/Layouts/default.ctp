...
<head>
	...
	<title>Matheus:<?php echo $this->fetch('title'); ?></title>
	...
	<?php
	    ...
	    <?php
		// Theme style
		echo $this->Html->css('dist/css/AdminLTE');
			...
			<!-- Content Wrapper. Contains page content -->
	      	<div class="content-wrapper">
				...
				<section class="content-header">
		        	<h1>
		          	...
		          	<?php //echo $this->Html->getCrumbs(' &raquo; ','Início'); ?>
			        <ol class="breadcrumb">
	      	...
	      	<footer class="main-footer">
				...
				<div class="pull-right hidden-xs">
					<?php echo __d('cake_dev', 'CakePHP %s', Configure::version()); ?>
